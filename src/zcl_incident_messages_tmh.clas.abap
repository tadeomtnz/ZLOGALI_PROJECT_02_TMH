CLASS zcl_incident_messages_tmh DEFINITION
  PUBLIC
  ...
  PUBLIC SECTION.
    ...
    CONSTANTS:
      gc_msgid TYPE symsgid VALUE 'ZMC_MESSAGE_INCT_TMH',

      BEGIN OF status_invalid,
        msgid TYPE symsgid VALUE 'ZMC_MESSAGE_INCT_TMH',
...
CLASS zcl_incident_messages_tmh IMPLEMENTATION.
